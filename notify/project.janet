(declare-project
  :name "void-notify"
  :description "void/notify — one notification, several channels: the :void.notify/channel point, a mail channel, an in-app bell over void/db, a signed webhook over void/http/client, and delivery through void/jobs.")
