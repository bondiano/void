...
| [0043](0043-dash-dev-dashbord-kak-chetvertaya-proekciya.md) | `void/dash` — dev-дашборд как четвёртая проекция; кольца фиксированной памяти; ворота по профилю; tap-инспектор | accepted |
