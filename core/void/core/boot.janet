...
(defn- load-manifests
  {:params [@[:any] @[:string]] :ret @[Manifest]}
...
(defn- run-on-load
  {:params [@[Manifest] :keyword @[:string]]
   :ret :nil}
...
(defn- split-active
  {:params [@[Manifest] LoadedConfig @[:string]]
...
(defn- build-system
  {:params [@[Manifest] @{:keyword Extension} LoadedConfig @[:string]]
   :ret System?}
