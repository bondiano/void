...
(def check "See entity/check — would this write be accepted, in schema/check's format." entity/check)
(def check! "See entity/check! — a check that raises the :void.schema/invalid envelope." entity/check!)
(def check-schema "See entity/check-schema — the schema a write is checked against." entity/check-schema)
