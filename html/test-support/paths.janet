...
# void-http (../http), void-dev (../dev, for void/test snapshots) and
# this package's own sources importable as void/... without installing
# any of them. jpm test runs each script with cwd = html/.
(defn- add-tree [root]
