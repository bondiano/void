(declare-project
  :name "void-pressure"
  :description "void/pressure — load shedding: an event-loop lag / RSS sampler, thresholds with recovery hysteresis, and a 503 + Retry-After for void/http while the process is over them."
  :version "0.0.1")
