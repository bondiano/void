# A product gets a picture. One nullable text column, and what it holds is
# a **storage key** — "products/2026/09/4f2a1c.png" — not a URL: the URL
# is computed by whichever store the composition resolved, so moving this
# shop from a disk to a bucket is a line of config and not a data
# migration.
#
