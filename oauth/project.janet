(declare-project
  :name "void-oauth"
  :description "void/oauth — \"sign in with a provider\": the OAuth 2.1 / OIDC client (ADR-0034) — authorization code + PKCE, the pending flow in the session, the id_token verified against the issuer's JWKS, and the verified visitor handed to the application's :void.oauth/sign-in."
  :version "0.0.1")

# The client half of what ADR-0032 started: void/auth is here for the
