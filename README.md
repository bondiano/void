...
Upcoming waves (see [docs/SPEC.md](docs/SPEC.md) §6): the rest of enterprise (`void/auth`, `void/authz`, `void/security`, `void/mail`, `void/bus`), then protocols and `void/admin`.
