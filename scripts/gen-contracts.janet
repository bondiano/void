...
(p "> declarations in the in-repo composition (void/http void/html")
(p "> void/htmx void/rest void/openapi void/db void/db-sqlite")
(p "> void/db-http void/dev void/bench). Do not edit the generated")
(p "> tables by hand — change the declaration and regenerate; CI fails")
(p "> on drift. The reserved-for-later tables are maintained in the")
(p "> generator script.")
(p "")
