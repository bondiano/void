...
# void-http (../http), void-rest (../rest) and this package's own
# sources importable as void/... without installing any of them. jpm
# test runs each script with cwd = openapi/.
(defn- add-tree [root]
