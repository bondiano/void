(declare-project
  :name "void-db-mysql"
  :description "void/db-mysql — MySQL as the :void/db-driver: libmysqlclient on a worker thread per connection, the blocking client API kept off the ev loop."
  :version "0.0.1")
...
# void/db-postgres has with libpq.
#
