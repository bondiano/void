(declare-project
  :name "void-mcp"
  :description "void/mcp — the application as an MCP server: :void.core/cli commands projected into tools, registered schemas and the health report into resources, JSON-RPC over stdio and over an ordinary HTTP route."
  :version "0.0.1"
